...
export default function FacebookActivityChart() {
  ...
  const fetchDailyActivity = async () => {
    try {
      ...
      console.error('Error fetching Facebook daily activity:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="w-full h-80">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="colorFbCount" x1="0" y1="0" x2="0" y2="1">
